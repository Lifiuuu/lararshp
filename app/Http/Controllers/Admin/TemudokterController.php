...
class TemudokterController extends Controller
{
    public function index()
    {
        ...
        return view('admin.temudokter.index', compact('temudokters', 'pets', 'doctors'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.temudokter.create', compact('pets', 'doctors'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.temudokter.edit', compact('temu'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.temudokter.index')->with('success', 'Status temu dokter diperbarui.');
    }
