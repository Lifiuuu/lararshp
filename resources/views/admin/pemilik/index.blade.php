    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="{{ route('admin.pemilik.edit', $pemilik->id ?? $pemilik->idpemilik) }}" class="btn-admin ghost">Edit</a>
                    <form action="{{ route('admin.pemilik.destroy', $pemilik->id ?? $pemilik->idpemilik) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Hapus pemilik ini?')">
                        @csrf
                        @method('DELETE')
