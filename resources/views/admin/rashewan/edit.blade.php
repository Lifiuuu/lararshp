		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						<form method="POST" action="{{ route('admin.rashewan.update', $ras->idras_hewan) }}">
							@csrf
							@method('PUT')
							...
							<div class="form-group">
								...
								<select class="form-control @error('idjenis_hewan') is-invalid @enderror" 
									...
									@foreach($jenisHewans as $jenis)
										<option value="{{ $jenis->idjenis_hewan }}" {{ old('idjenis_hewan', $ras->idjenis_hewan) == $jenis->idjenis_hewan ? 'selected' : '' }}>
