<!-- admin temudokter edit -->
@extends('layouts.lte.main')

@section('content')
    <h1>Edit Temu Dokter #{{ $temu->idreservasi_dokter }} (Admin)</h1>

    <form method="POST" action="{{ route('admin.temudokter.update', $temu->idreservasi_dokter) }}">
        @csrf
        @method('PUT')
        <div>
