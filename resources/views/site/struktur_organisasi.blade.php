        ...
        <div class="container">
            ...
            <div style="display: flex; justify-content: center; margin-bottom: 2.5rem;">
                <div class="feature-item" style="text-align: center; max-width: 450px;">
                    <h3>DIREKTUR</h3>
                    <img src="{{ asset('assets/images/direktur.jpg') }}" alt="Direktur" class="profile-pic">
            ...
            <div class="features-grid">
                ...
                <div class="feature-item" style="text-align: center;">
                    ...
                    <img src="{{ asset('assets/images/wadek1.jpg') }}" alt="Wadir 1" class="profile-pic">
                ...
                <div class="feature-item" style="text-align: center;">
                    ...
                    <img src="{{ asset('assets/images/wadek2.jpg') }}" alt="Wadir 2" class="profile-pic">
